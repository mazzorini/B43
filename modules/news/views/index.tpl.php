...
<div class="card-footer">
	...
	<?php endif ?>
	<?php if ($content): ?>
		<a href="<?php echo url('news/'.$news_id.'/'.url_title($title)) ?>" class="btn btn-sm btn-secondary float-right"><?php echo $this->lang('Read more') ?></a>
	<?php endif ?>
</div>
<?php endif ?>
