<div class="list-group list-group-flush">
	<a href="<?php echo url('search?q='.rawurlencode($keywords)) ?>" class="list-group-item<?php echo $this->url->request == 'search' ? ' active' : '' ?>"><?php echo $this->lang('All results') ?> <span class="label float-right"><?php echo $count ?></span></a>
