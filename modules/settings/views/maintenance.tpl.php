	...
	<header class="masthead mb-auto">
		<div class="inner">
			...
			<nav class="nav nav-masthead justify-content-center">
				...
				<?php endif ?>
				<?php echo $this->user() ? '<a href="'.url('user/logout').'" class="nav-link">'.icon('fas fa-times').' Déconnexion'.'</a>' : '<a href="#" class="nav-link ml-5" data-modal-ajax="'.url('ajax/user/login').'">'.icon('fas fa-sign-in-alt').' Login'.'</a>' ?>
			</nav>
		</div>
	</header>
